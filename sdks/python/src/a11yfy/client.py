...
class BaseA11yfy:
    ...
    environment : BaseA11yfyEnvironment
        The environment to use for requests from the client. from .environment import BaseA11yfyEnvironment



        Defaults to BaseA11yfyEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: BaseA11yfyEnvironment = BaseA11yfyEnvironment.DEFAULT,
        token: typing.Union[str, typing.Callable[[], str]],
    ...
    def certificates(self):
        if self._certificates is None:
            from .certificates.client import CertificatesClient  # noqa: E402
...
class AsyncBaseA11yfy:
    ...
    def certificates(self):
        if self._certificates is None:
            from .certificates.client import AsyncCertificatesClient  # noqa: E402

            self._certificates = AsyncCertificatesClient(client_wrapper=self._client_wrapper)
        return self._certificates


def _get_base_url(*, base_url: typing.Optional[str] = None, environment: BaseA11yfyEnvironment) -> str:
